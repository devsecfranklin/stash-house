...
% https://doi.org/10.5281/zenodo.17442786
...
\begin{document}
{
\usebackgroundtemplate{\includegraphics[width=\paperwidth]{../static/images/technology-presentation.jpg}}%
\begin{frame}
	% \titlepagestash apply
...
{
    \usebackgroundtemplate{\includegraphics[width=\paperwidth]{../static/images/section.jpg}}
    \sectionsubtitle{\textcolor{black}{The Lost Art of Keeping a Secret}}
    \section{Introduction}
}

{
    \usebackgroundtemplate{\includegraphics[width=\paperwidth]{../static/images/tech-back.jpg}}%
    \begin{frame}
...
{
	\usebackgroundtemplate{\includegraphics[width=\paperwidth]{../static/images/tech-white.jpg}}%
	\begin{frame}
...
{
    \begin{frame}{movie}
        \frametitle{Video: Setup}
        \begin{figure}[h!]

            \centering
            \movie[label=show1\textwidth,poster
            ,autostart,showcontrols,loop]
            {\includegraphics[width=0.25\textwidth]{../static/images/play.png}}{../static/video/bootstrap.sh.mp4}
            \caption{\textcolor{black}{Video: Setup}}
        \end{figure}
    \end{frame}
}
...
{
    \begin{frame}{movie}
        \frametitle{Video: Install Client}
        \begin{figure}[h!]

            \centering
            \movie[label=show2\textwidth,poster
            ,autostart,showcontrols,loop]
            {\includegraphics[width=0.25\textwidth]{../static/images/play.png}}{../static/video/installclient.sh.mp4}
            \caption{\textcolor{black}{Local Client Installation}}
        \end{figure}
    \end{frame}
}
...
{
    \begin{frame}{movie}
        \frametitle{Demo Script: Scan Local System}
        \begin{figure}[h!]

            \centering
            \movie[label=show3\textwidth,poster
            ,autostart,showcontrols,loop]
            {\includegraphics[width=0.25\textwidth]{../static/images/play.png}}{../static/video/scanlocal.sh.mp4}
            \caption{\textcolor{black}{Setup Video Two}}
        \end{figure}
    \end{frame}
}
...
{
	\usebackgroundtemplate{\includegraphics[width=\paperwidth]{../static/images/section.jpg}}
	\sectionsubtitle{\textcolor{black}{We found the secrets, now what?}}
