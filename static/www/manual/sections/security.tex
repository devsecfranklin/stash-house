...
All hosts use standardized \texttt{hardening.conf} drop-ins in /etc/ssh/sshd\_config.d/:
...
\begin{itemize}
    ...
    \item \textbf{Explicit user key sync} -- ed25519 keys deployed to target hosts via ansible ssh role; no manual key management
\end{itemize}
