# OGC Principal Investigator (PI) requirements

Here is a list of the trainings required by the Office of Grants & Contracts (OGC) for any Project Director/Principal Investigator prior to any submission:

1. Direct Charging to Sponsored Projects, Course No. U00059; and
2. Electronic Personnel Effort Reporting, Course No. U00055.
...
5.        Click on the box on the left, “Submit/Update Conflict of Interest Disclosure”

Once inside the conflict of interest disclosure, answer each of the questions.
Make sure you mark each page complete before you move on to another tab. On the final
page mark complete AND do not forget to click the submit button on the bottom.