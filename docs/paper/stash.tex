...
user secrets for safe storage, an additional security safeguard can be implemented by simply storing your data in a ``local'' fashion.
That is to say, the encrypted data stays within the Enterprise Network or Administrative Domain, with the goal of reducing it's accessibility those who are unauthorized.

\section{Distributed Back End Storage}

The Federated Open Key Service\cite{foks}
